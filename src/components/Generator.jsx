...
import SectionWapper from './SectionWrapper'
    ...
    return(
        <div className='flex flex-col gap-4'>
            <div className='flex items-center justify-center gap-2'>
                <p className='text-4xl sm:text-4xl md:text-5xl font-semibold text-slate-400'>{index}</p>
...
export default function Generator(props) {
    ...
    return (
        <SectionWapper id={'generate'} header={"generate your workout"} title={['It\'s', 'Huge', 'o\'clock']}>
            ...
            <div className='bg-slate-950 border border-solid border-blue-400 rounded-lg flex flex-col'>
                ...
                <button onClick={toggleModel} className='relative p-3 flex items-center justify-center'>
                    ...
                    <i className="fa-solid absolute right-3 top-1/2 transform -translate-y-1/2 fa-sort-down"></i>
                </button>
                {showModel && (
